// Single source of truth for the AI Employees roster copy - used by both
// /ai-employees and the landing page's roster section, so the two can never
// drift apart and say different things about the same product.
