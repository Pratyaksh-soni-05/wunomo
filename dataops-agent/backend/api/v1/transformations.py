...
@router.post("/run/sql")
async def run_sql(body: RunSqlRequest, user=Depends(require_permission("transforms.execute"))):
    """
...
async def run_pandas(body: RunPandasRequest, user=Depends(require_permission("transforms.execute"))):
    """
